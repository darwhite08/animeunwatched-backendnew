...
export type LoginAttemptOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"email" | "count" | "lockedUntil" | "updatedAt", ExtArgs["result"]["loginAttempt"]>
...
export interface LoginAttemptDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const loginAttemptWithEmailOnly = await prisma.loginAttempt.findMany({ select: { email: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many LoginAttempts and only return the `email`
   * const loginAttemptWithEmailOnly = await prisma.loginAttempt.createManyAndReturn({
   *   select: { email: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more LoginAttempts and only return the `email`
   * const loginAttemptWithEmailOnly = await prisma.loginAttempt.updateManyAndReturn({
   *   select: { email: true },
   *   where: {
   *     // ... provide filter here
   *   },
