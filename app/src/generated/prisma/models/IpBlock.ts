...
export type IpBlockWhereInput = {
  ...
  reason?: Prisma.StringFilter<"IpBlock"> | string
  blockedBy?: Prisma.StringNullableFilter<"IpBlock"> | string | null
  expiresAt?: Prisma.DateTimeFilter<"IpBlock"> | Date | string
...
export type IpBlockScalarWhereWithAggregatesInput = {
  ...
  reason?: Prisma.StringWithAggregatesFilter<"IpBlock"> | string
  blockedBy?: Prisma.StringNullableWithAggregatesFilter<"IpBlock"> | string | null
  expiresAt?: Prisma.DateTimeWithAggregatesFilter<"IpBlock"> | Date | string
...
export type IpBlockOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"ip" | "reason" | "blockedBy" | "expiresAt" | "createdAt", ExtArgs["result"]["ipBlock"]>
...
export interface IpBlockDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `ip`
   * const ipBlockWithIpOnly = await prisma.ipBlock.findMany({ select: { ip: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many IpBlocks and only return the `ip`
   * const ipBlockWithIpOnly = await prisma.ipBlock.createManyAndReturn({
   *   select: { ip: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more IpBlocks and only return the `ip`
   * const ipBlockWithIpOnly = await prisma.ipBlock.updateManyAndReturn({
   *   select: { ip: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface IpBlockFieldRefs {
  ...
  readonly blockedBy: Prisma.FieldRef<"IpBlock", 'String'>
  readonly expiresAt: Prisma.FieldRef<"IpBlock", 'DateTime'>
