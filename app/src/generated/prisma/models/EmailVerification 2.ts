...
export type EmailVerificationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "codeHash" | "expiresAt" | "attempts" | "sentAt", ExtArgs["result"]["emailVerification"]>
...
export interface EmailVerificationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const emailVerificationWithUserIdOnly = await prisma.emailVerification.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many EmailVerifications and only return the `userId`
   * const emailVerificationWithUserIdOnly = await prisma.emailVerification.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more EmailVerifications and only return the `userId`
   * const emailVerificationWithUserIdOnly = await prisma.emailVerification.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
