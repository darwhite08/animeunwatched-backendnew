...
export type PayoutAccountCountAggregateOutputType = {
  userId: number
  provider: number
  providerAcctId: number
  onboarded: number
  taxFormStatus: number
...
type GetPayoutAccountGroupByPayload<T extends PayoutAccountGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type PayoutAccountWhereInput = {
  ...
  provider?: Prisma.StringFilter<"PayoutAccount"> | string
  providerAcctId?: Prisma.StringNullableFilter<"PayoutAccount"> | string | null
  onboarded?: Prisma.BoolFilter<"PayoutAccount"> | boolean
  taxFormStatus?: Prisma.StringFilter<"PayoutAccount"> | string
  payoutsEnabled?: Prisma.BoolFilter<"PayoutAccount"> | boolean
...
export type PayoutAccountOrderByWithRelationInput = {
  ...
  providerAcctId?: Prisma.SortOrderInput | Prisma.SortOrder
  onboarded?: Prisma.SortOrder
  taxFormStatus?: Prisma.SortOrder
...
export type PayoutAccountScalarWhereWithAggregatesInput = {
  ...
  provider?: Prisma.StringWithAggregatesFilter<"PayoutAccount"> | string
  providerAcctId?: Prisma.StringNullableWithAggregatesFilter<"PayoutAccount"> | string | null
  onboarded?: Prisma.BoolWithAggregatesFilter<"PayoutAccount"> | boolean
  taxFormStatus?: Prisma.StringWithAggregatesFilter<"PayoutAccount"> | string
  payoutsEnabled?: Prisma.BoolWithAggregatesFilter<"PayoutAccount"> | boolean
...
export type PayoutAccountUpdateInput = {
  ...
  providerAcctId?: Prisma.NullableStringFieldUpdateOperationsInput | string | null
  onboarded?: Prisma.BoolFieldUpdateOperationsInput | boolean
  taxFormStatus?: Prisma.StringFieldUpdateOperationsInput | string
...
export type PayoutAccountCountOrderByAggregateInput = {
  userId?: Prisma.SortOrder
  provider?: Prisma.SortOrder
  providerAcctId?: Prisma.SortOrder
  onboarded?: Prisma.SortOrder
  taxFormStatus?: Prisma.SortOrder
  payoutsEnabled?: Prisma.SortOrder
...
export type PayoutAccountSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  userId?: boolean
  provider?: boolean
  providerAcctId?: boolean
  onboarded?: boolean
  taxFormStatus?: boolean
  payoutsEnabled?: boolean
  country?: boolean
  createdAt?: boolean
  updatedAt?: boolean
...
export type PayoutAccountOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"userId" | "provider" | "providerAcctId" | "onboarded" | "taxFormStatus" | "payoutsEnabled" | "country" | "createdAt" | "updatedAt", ExtArgs["result"]["payoutAccount"]>
...
export interface PayoutAccountDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const payoutAccountWithUserIdOnly = await prisma.payoutAccount.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many PayoutAccounts and only return the `userId`
   * const payoutAccountWithUserIdOnly = await prisma.payoutAccount.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more PayoutAccounts and only return the `userId`
   * const payoutAccountWithUserIdOnly = await prisma.payoutAccount.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface PayoutAccountFieldRefs {
  ...
  readonly provider: Prisma.FieldRef<"PayoutAccount", 'String'>
  readonly providerAcctId: Prisma.FieldRef<"PayoutAccount", 'String'>
  readonly onboarded: Prisma.FieldRef<"PayoutAccount", 'Boolean'>
  readonly taxFormStatus: Prisma.FieldRef<"PayoutAccount", 'String'>
  readonly payoutsEnabled: Prisma.FieldRef<"PayoutAccount", 'Boolean'>
